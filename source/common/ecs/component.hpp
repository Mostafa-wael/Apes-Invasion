...
namespace our {
    ...
    class Component : public IImGuiDrawable {
        Entity* owner = nullptr; // A pointer to the entity that owns this component
    ...
    public:
        ...
        // Used for polymorphically getting component names when we want runtime polymorphism
