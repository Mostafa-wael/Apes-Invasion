...
namespace our {
    ...
    public:
        ...
        void update(World* world, float deltaTime) {
            ...
            if(app->getMouse().isPressed(GLFW_MOUSE_BUTTON_2) && !mouse_locked) {
                app->getMouse().lockMouse(app->getWindow());
                mouse_locked = true;
                // If the left mouse button is released, we unlock and unhide the mouse.
            } else if(!app->getMouse().isPressed(GLFW_MOUSE_BUTTON_2) && mouse_locked) {
            ...
            glm::vec3 front = entity->getForward(),
                      up    = entity->getUp(),
